  ...
  return (
    <div className="mx-4 mt-32">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-4 w-full">
        <Figure02 img="/images/process/request.png" title="출장요청" sub="고객상담" sub2="방문날짜확정" />
        {browserWidth > 768 ? <IconLeft /> : <IconDown />} {/* 화면 크기에 따라 아이콘 변경 */}
        <Figure02 img="/images/process/visit.png" title="현장진단" sub="문제점파악" sub2="솔루션제안" />
        {browserWidth > 768 ? <IconLeft /> : <IconDown />}
        <Figure02 img="/images/process/progress.png" title="작업진행" sub="청소 및 유지보수" sub2="점검 완료" />
        {browserWidth > 768 ? <IconLeft /> : <IconDown />}
        <Figure02 img="/images/process/check.png" title="사후관리" sub="만족도 조사" sub2="추가 지원 제공" />
      </div>
